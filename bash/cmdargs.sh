...
vebose1=0
debug2=0
# a variables is created to find the stat of the input
...
while [ $# -gt 0 ]; do
  ...
  *)
  ...
  shift
  # line argument command is shifted to process the next element
...
# to check stat of the variable if condition is used
if [ $vebose1 = 1 ]; then
...
# to check stat of the variable if condition is used
if [ $debug2 -gt 0 ]; then
  echo "Debug Mode is On with debug level $debug2."
else
