...
# using mkdir to make the picture directory  
...
#  by online download a tarfile of pictures to the directory of the  Pictures 
...
# unload the tarfile that is  downloaded and then delete the local copy of the tarfile
